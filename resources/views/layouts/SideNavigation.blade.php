<nav class="Side-Menu">
    ...
    <ul class="Side-Ul text-center">
        ...
        <li  class="{{Request::path() === "assigment" ? 'active':''  }}" ><a href=""><i class="fas fa-file-alt"></i><p>Assigment</p></a></li>
        ...
        <li  class="{{Request::path() === "profile"   ? 'active':''  }}" ><a href=""><i class="fas fa-user-circle"></i><p>Profile</p></a></li>
    </ul>
